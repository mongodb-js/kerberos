...
The MongoDB Node.js team is pleased to announce version ${version.version} of the \`kerberos\` package!

${highlights}
${history}
## Documentation

* [Changelog](https://github.com/mongodb-js/kerberos/blob/v${version.version}/HISTORY.md)

We invite you to try the \`kerberos\` library immediately, and report any issues to the [NODE project](https://jira.mongodb.org/projects/NODE).
`;
