...
Kerberos.prototype.authGSSClientWrap = function(context, challenge, user_name, callback) {
  ...
  return this._native_kerberos.authGSSClientUnwrap(context, challenge, user_name, callback);
}

Kerberos.prototype.authGSSClientClean = function(context, callback) {
  return this._native_kerberos.authGSSClientUnwrap(context, callback);
}
