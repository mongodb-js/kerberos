...
- `npm run docs` — regenerate README.md from JSDoc in `lib/index.js` (never edit README.md directly, edit `etc/README.hbs` or the JSDoc). README.md must be deleted before running this.
